...
export default function Navbar(props) {
    ...
    return (
        <nav className={`navbar ${isMenuOpen ? 'navbar-open' : ''}`} id="navbar">
            <div className="container flex flex-wrap items-center justify-between">
                ...
                <div className="nav-icons flex items-center lg_992:order-2 ms-4 lg:ms-8">
                    {/* Navbar Button */}
                    {social && (
                ...
                {/* Navbar Manu */}
                <div className={`navigation lg_992:order-1 lg_992:flex ms-auto ${isMenuOpen ? 'block' : 'hidden'}`} id="menu-collapse">
                    <ul className="navbar-nav" id="navbar-navlist">
                        <li className="nav-item">
                            <Link1 to="home" activeClass="active" spy={true} smooth={true} duration={500} className="nav-link ms-1">Home</Link1>
                        </li>
                        {data.services && (
                            <li className="nav-item">
