            ...
            <div className="container">
                <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    <div>
                        ...
                        <TypeAnimation
                            sequence={[
                                ...
                                data&&data.about?data.about.name:"N/A",
                                1000, // wait 1s before replacing "Mice" with "Hamsters"
                                data&&data.about?data.about.title:"N/A",
                                1000,
                            ]}
                            wrapper="span"
                            speed={50}
                            ...
                            repeat={Infinity}
                        />
                        <span className="typewrite text-amber-500" data-period="2000" data-type={`[${data&&data.about?data.about.name:"N/A"},${data&&data.about?data.about.title:"N/A"}]`}> <span className="wrap"></span> </span></h4>
                        <p className="text-slate-400 max-w-xl">{data&&data.about?data.about.description:"N/A"}</p>
                    ...
                    <div className="relative">
                        <img src={data&&data.about?data.about.avatar.url:"/images/hero/2.png"} style={{height:"100vh"}} alt=""/>
                        ...
                        <div className="absolute lg:bottom-20 md:bottom-10 bottom-2 ltr:md:-left-5 ltr:left-2 rtl:md:-right-5 rtl:right-2 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 m-3 w-44 text-center">
                            <span className="text-3xl font-medium mb-0"><span className="counter-value font-bold" data-target="125"> <CountUp
                                            ...
                                            end={data&&data.about?data.about.some_total:"1"}
                                            duration={2.75} /></span>+</span>
                            <h6 className="text-sm text-slate-400 mt-1">Project Completed</h6>
                        </div>

                        <div className="absolute lg:top-80 md:top-56 top-48 ltr:md:-right-0 ltr:right-2 rtl:md:-left-0 rtl:left-2 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 m-4 w-50 text-center">
                            <h6 className="font-semibold">{data&&data.about?data.about.title:"N/A"}</h6>
                            <h6 className="text-sm text-slate-400 mt-1">{data&&data.about?data.about.exp_year:"N/A"}+ Years Experience</h6>
                        </div>
                    </div>
                </div>
            </div>
